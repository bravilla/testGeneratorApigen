...
@Component
@Slf4j
public class PostAlumnosGetOutputMapper extends JapiAbstractCustomMapper<PostAlumnosGetOutputDTO, Alumno> {
    private AlumnosOutputMapper alumnosOutputMapper = new AlumnosOutputMapper();

    public PostAlumnosGetOutputDTO entityToDto(List<Alumno> entity) {
        Assert.notNull(entity, "El parÃ¡metro entity es nulo");
        PostAlumnosGetOutputDTO dto = new PostAlumnosGetOutputDTO();
    ...
    public class AlumnosOutputMapper {
        public PostAlumnosGetOutputDTO.AlumnosOutputDTO entityToDto(Alumno entity) {
            Assert.notNull(entity, "El parÃ¡metro entity es nulo");
            PostAlumnosGetOutputDTO.AlumnosOutputDTO dto = new PostAlumnosGetOutputDTO.AlumnosOutputDTO();

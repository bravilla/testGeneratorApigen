...
@Component
@Slf4j
public class PostAlumnosGetInputMapper extends JapiAbstractCustomMapper<PostAlumnosGetInputDTO, Alumno> {
    public Alumno dtoToEntity(PostAlumnosGetInputDTO dto) {

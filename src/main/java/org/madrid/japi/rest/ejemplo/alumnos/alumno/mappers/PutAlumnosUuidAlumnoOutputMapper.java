...
@Component
@Slf4j
public class PutAlumnosUuidAlumnoOutputMapper extends JapiAbstractCustomMapper<PutAlumnosUuidAlumnoOutputDTO, Alumno> {
    public PutAlumnosUuidAlumnoOutputDTO entityToDto(Alumno entity) {
        Assert.notNull(entity, "El parÃ¡metro entity es nulo");
        PutAlumnosUuidAlumnoOutputDTO dto = new PutAlumnosUuidAlumnoOutputDTO();

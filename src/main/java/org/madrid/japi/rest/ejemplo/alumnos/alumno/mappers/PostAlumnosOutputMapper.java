...
@Component
@Slf4j
public class PostAlumnosOutputMapper extends JapiAbstractCustomMapper<PostAlumnosOutputDTO, Alumno> {
    public PostAlumnosOutputDTO entityToDto(Alumno entity) {
        Assert.notNull(entity, "El parÃ¡metro entity es nulo");
        PostAlumnosOutputDTO dto = new PostAlumnosOutputDTO();

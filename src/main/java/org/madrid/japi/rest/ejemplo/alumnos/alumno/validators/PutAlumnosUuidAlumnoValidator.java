...
/**
 * Servicio de validaciÃ³n de la clase de dominio Alumno: <code>{@link PutAlumnosUuidAlumnoValidator}</code><br/>
 * @author Generador de API Rest 
 * @since 28-sep-2022 16:05:10
 */
@Service("PutAlumnosUuidAlumnoValidator")
public class PutAlumnosUuidAlumnoValidator extends JapiAbstractCustomValidator<PutAlumnosUuidAlumnoInputDTO> implements JapiCustomValidator<PutAlumnosUuidAlumnoInputDTO> {
    /**
     * mÃ©todo de validaciÃ³n del DTO de entrada, de haber algÃºn fallo se devuelve un listado con los errores.
     */
    @Override
    public void doValidate(PutAlumnosUuidAlumnoInputDTO inputDTO) throws JapiException {

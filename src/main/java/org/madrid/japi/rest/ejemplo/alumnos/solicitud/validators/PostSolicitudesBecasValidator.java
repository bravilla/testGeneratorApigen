package org.madrid.japi.rest.ejemplo.alumnos.solicitud.validators;
...
/**
 * Servicio de validaciÃ³n de la clase de dominio Solicitud: <code>{@link PostSolicitudesBecasValidator}</code><br/>
 * @author Generador de API Rest 
 * @since 28-sep-2022 16:05:10
 */
@Service("PostSolicitudesBecasValidator")
public class PostSolicitudesBecasValidator extends JapiAbstractCustomValidator<PostSolicitudesBecasInputDTO> implements JapiCustomValidator<PostSolicitudesBecasInputDTO> {
    /**
     * mÃ©todo de validaciÃ³n del DTO de entrada, de haber algÃºn fallo se devuelve un listado con los errores.
     */
    @Override
    public void doValidate(PostSolicitudesBecasInputDTO inputDTO) throws JapiException {
